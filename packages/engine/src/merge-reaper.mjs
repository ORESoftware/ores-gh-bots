import { parsePullRequestDependencies as parseCanonicalPullRequestDependencies } from '../../core/src/pr-dependencies.mjs';
...
export function parseMergeReaperDependencies(body, { owner, repo }) {
  return parseCanonicalPullRequestDependencies(body, { owner, repo })
