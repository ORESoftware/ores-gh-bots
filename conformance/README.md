...
`contracts/` is the authority for API and data-shape semantics in `ORESoftware/ores-gh-bots`. `conformance/` is the shared behavioral corpus that runtime implementations, adapters, and compatibility layers must consume.
