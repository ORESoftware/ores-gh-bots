...
test('merge reaper consumes the canonical PR dependency parser and deduplicates keys', () => {
  const dependencies = parseMergeReaperDependencies(`
Depends-On: Other/Library#19
Depends-On: #3
