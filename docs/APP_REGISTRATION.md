...
3. Open each local form, inspect the permissions GitHub displays, and create the App. GitHub redirects to the configured manifest callback with one-time `code` and `state` query values.
