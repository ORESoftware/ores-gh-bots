...
# Nightly cross-org PR reconciler, fleet hygiene, and fleet push

The evented review control plane above is the primary review trigger. The nightly pass below is the safety net underneath it (DEN-3946); it should enqueue current-SHA reviews through the control plane rather than act as the primary trigger.

The **nightly cross-org PR reconciler**: it walks every open
